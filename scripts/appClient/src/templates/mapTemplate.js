		...
		"<div class='navbar-inner'>",
			"<div class='container'>",
				"<ul class='navbar-nav iconsNav navToggles' id='agencyToggles'>",
					...
					"{{/each}}",
					"<li style=\"width: 80px\"><a href='#' id='ownerToggleTribal' class='tribalToggle' data-layerlabel=''> <i class=\"icon\">&#x2109;</i><div class='txt'>TRIBAL</div></a></li>",
					"<li style=\"width: 80px\"><a href='#' id='ownerToggleFederal' class='federalToggle' data-layerlabel=''> <i class=\"icon\">&#x2109;</i><div class='txt'>FEDERAL</div></a></li>",
					"<li style=\"width: 80px\"><a href='#' id='ownerToggleOtherPublicLand' class='otherToggle' data-layerlabel=''> <i class=\"icon\">&#x2109;</i><div class='txt'>OTHER</div></a></li>",
				"</ul>",
				"<ul class='navbar-nav iconsNav navToggles' id='landUseToggles' style='display:none;'>",
					"<li style=\"width: 80px\"><a href='#' id='ownerToggleRevenueProducing' class='landuseToggle' data-layerlabel=''> <i class=\"icon\">&#x2109;</i><div class='txt'>REVENUE</div></a></li>",
					"<li style=\"width: 80px\"><a href='#' id='ownerToggleHabitat' class='landuseToggle' data-layerlabel=''> <i class=\"icon\">&#x21fc;</i><div class='txt'>HABITAT</div></a></li>",
					"<li style=\"width: 80px\"><a href='#' id='ownerToggleRecreation' class='landuseToggle' data-layerlabel=''> <i class=\"icon\">&#x21c7;</i><div class='txt'>RECREATION</div></a></li>",
					"<li style=\"width: 100px\"><a href='#' id='ownerToggleConservation' class='landuseToggle' data-layerlabel=''> <i class=\"icon\" style=\"margin-left:20px\">&#x2150;</i><div class='txt'>CONSERVATION</div></a></li>",
				"</ul>",

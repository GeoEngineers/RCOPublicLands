...
MainApplication.Templates.MapPaneTemplate = [
	"<div id='summaryPanelBlock'>",
		...
		"<div id='landUseWarning'>\"Land Use\" does not include Federal lands.</div>",
		...
		"<div class='modal-content'>",
			...
			"<div class='modal-body'>",
				...
				"<div class='aboutLogos'>",
					"<a href='http://www.wdfw.wa.gov' target='_blank'><img src='./content/images/logos/LogoWADFW-sm.jpg' /></a>",
					"<a href='http://www.dnr.wa.gov' target='_blank'><img src='./content/images/logoWADNR.jpg' style='width: 200px' /></a>",
					"<a href='http://www.rco.wa.gov/' target='_blank'><img src='./content/images/logo.jpg' style='max-width: 200px' /></a>",
					"<a href='http://www.parks.wa.gov' target='_blank'><img src='./content/images/logos/WSPLogo_200.png' /></a>",
				"</div>",
			"</div>",

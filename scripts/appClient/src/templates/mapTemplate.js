		...
		"<div class='navbar-inner'>",
			"<div class='container'>",
				"<ul class='navbar-nav iconsNav'>",
					"<li id='lnkChart' href='#SummaryPaneSlideOut' class='slide-menu'><a href='#'>&#9776;<div class='txt'>Compare</div></a></li>",
				"</ul>",
				"<ul class='navbar-nav iconsNav' style='float:right;'>",
					"<li id='lnkSlideMenu' class='navLink'><a href='#'><i class='icon-bar-chart icon-large'></i><div class='txt'>Navigation</div></a></li>",
				"</ul>",				
			"</div>",
		"</div>",
	"</div>"

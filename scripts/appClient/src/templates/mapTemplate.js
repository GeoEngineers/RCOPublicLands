	...
	"<div>",
		...
		"<ul id='map-slide-button'>",
			"<div class='btn-group'>",
				...
				"</ul>",
				"<ul class='navbar-nav iconsNav iconsNav-right' style='float:right;'>",
					"<li style='padding:5px 20px 0px 0px;'><a href='#' class='navLink baseMapLink' data-maptype='osm' href='#'><i class=\"icon\" style=\"margin:0px; width: 16px; height:16px; font-size: 15px;\">&#x2106;</i><div class='txt'>Open Street Map</div></a></li>",
					"<li style='padding:5px 20px 0px 0px;'><a href='#' class='navLink baseMapLink' data-maptype='streets' href='#'><i class=\"icon\" style=\"margin:0px; width: 16px; height:16px; font-size: 15px;\">&#x2106;</i><div class='txt'>Streets</div></a></li>",
					"<li style='padding:5px 20px 0px 0px;'><a href='#' class='navLink baseMapLink' data-maptype='imagery' href='#'><i class=\"icon\" style=\"margin:0px; width: 16px; height:16px; font-size: 15px;\">&#x2106;</i><div class='txt'>Imagery</div></a></li>",
				"</ul>",
			"</div>",
		"</ul>",
		"<ul id='map-buttons'>",
		...
		"<div class='navbar-inner'>",
			"<div class='container'>",
				...
				"<ul class='navbar-nav iconsNav navToggles' id='landUseToggles' style='display:none;'>",
					"<li style=\"width: 80px\"><a href='#' id='landuseToggleREVENUE' class='landuseToggle' data-layerlabel='REVENUE'> <i class=\"icon\">&#x2109;</i><div class='txt'>REVENUE</div></a></li>",
					"<li style=\"width: 80px\"><a href='#' id='landuseToggleHABITAT' class='landuseToggle' data-layerlabel='HABITAT'> <i class=\"icon\">&#x21fc;</i><div class='txt'>HABITAT</div></a></li>",
					"<li style=\"width: 80px\"><a href='#' id='landuseToggleRECREATION' class='landuseToggle' data-layerlabel='RECREATION'> <i class=\"icon\">&#x21c7;</i><div class='txt'>RECREATION</div></a></li>",
					"<li style=\"width: 100px\"><a href='#' id='landuseToggleCONSERVATION' class='landuseToggle' data-layerlabel='CONSERVATION'> <i class=\"icon\" style=\"margin-left:20px\">&#x2150;</i><div class='txt'>CONSERVATION</div></a></li>",
				"</ul>",

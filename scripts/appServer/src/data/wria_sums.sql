...
SELECT SUM(st_area(st_intersection(a.geom, b.geom)) / 43560) as Acres, sum(a.acquisition_cost) as AcquisitionCost, b.wria_nm as areaname, 'AQ-DFW' as agency
  ...
  ST_Intersects(a.geom, b.geom) Group by b.wria_nm
Union
SELECT SUM(st_area(st_intersection(a.geom, b.geom)) / 43560) as Acres, sum(a.acquisition_cost) as AcquisitionCost, b.wria_nm as areaname, 'AQ-STATE' as agency
  FROM vw_rco_publiclands_acq_state a Join publiclands_wira_bnd b on
  ST_Intersects(a.geom, b.geom) Group by b.wria_nm
Union
SELECT SUM(st_area(st_intersection(a.geom, b.geom)) / 43560) as Acres, sum(a.acquisition_cost) as AcquisitionCost, b.wria_nm as areaname, 'AQ-DNR-UPLANDS' as agency
  FROM vw_rco_publiclands_dnr_uplands a Join publiclands_wira_bnd b on
  ST_Intersects(a.geom, b.geom) Group by b.wria_nm
Union
SELECT SUM(st_area(st_intersection(a.geom, b.geom)) / 43560) as Acres, sum(a.acquisition_cost) as AcquisitionCost, b.wria_nm as areaname, 'AQ-DNR-AQUATIC' as agency
  FROM vw_rco_publiclands_dnr_aquatic a Join publiclands_wira_bnd b on
  ST_Intersects(a.geom, b.geom) Group by b.wria_nm
Union

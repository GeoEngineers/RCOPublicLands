...
SELECT Sum(a.acres) as Acres, sum(a.acquisition_cost) as AcquisitionCost, b.sldust12 as areaname, 'AQ-DFW' as agency
  ...
  ST_Intersects(a.geom, b.geom) Group by b.sldust12
Union
SELECT Sum(a.acres) as Acres, sum(a.acquisition_cost) as AcquisitionCost, b.sldust12 as areaname, 'AQ-STATE' as agency
  FROM vw_rco_publiclands_acq_state a Join publiclands_2012_leg_districts b on
  ST_Intersects(a.geom, b.geom) Group by b.sldust12
Union
SELECT Sum(a.acres) as Acres, sum(a.acquisition_cost) as AcquisitionCost, b.sldust12 as areaname, 'AQ-DNR-UPLANDS' as agency
  FROM vw_rco_publiclands_dnr_uplands a Join publiclands_2012_leg_districts b on
  ST_Intersects(a.geom, b.geom) Group by b.sldust12
Union
SELECT Sum(a.acres) as Acres, sum(a.acquisition_cost) as AcquisitionCost, b.sldust12 as areaname, 'AQ-DNR-AQUATIC' as agency
  FROM vw_rco_publiclands_dnr_aquatic a Join publiclands_2012_leg_districts b on
  ST_Intersects(a.geom, b.geom) Group by b.sldust12
Union
...
SELECT Sum(a.acres) as Acres, sum(a.acquisition_cost) as AcquisitionCost, b.sldust12 as areaname, 'PARKS' as agency
  FROM vw_rco_publiclands_park a Join publiclands_2012_leg_districts b on
  ST_Intersects(a.geom, b.geom) Group by b.sldust12
Union

...
CREATE TABLE todo_user ( 
	...
	CONSTRAINT uid_pkey UNIQUE ( uid )
 );
...
(
  ...
  created_by_user_uid uuid NULL,
  assigned_to_user_uid uuid NULL,
...
ALTER TABLE todo_item ADD CONSTRAINT todo_item_created_by_user_uid_fkey FOREIGN KEY ( created_by_user_uid ) REFERENCES todo_user( uid );
ALTER TABLE todo_item ADD CONSTRAINT todo_item_assigned_to_user_uid_fkey FOREIGN KEY ( assigned_to_user_uid ) REFERENCES todo_user( uid );
